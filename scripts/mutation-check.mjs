...
const MUTATIONS = [
  ...
  },
  {
    ...
    file: "apps/worker/src/jobs/linkedin-action.ts",
    from: "  const body = renderCta(renderTemplate(withPitch.message, prospect.first_name), ctaUrl);",
    to: "  const body = renderTemplate(withPitch.message, prospect.first_name);",
    pkg: "@le/worker",
  },
  {
