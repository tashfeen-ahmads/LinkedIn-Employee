...
const MUTATIONS = [
  ...
  },
  {
    ...
    file: "apps/worker/src/accounts.ts",
    from: "    const result = await reconcileAccount(db, row.workspace_id, row.user_id, mine);",
  ...
  },
  {
    ...
    file: "apps/worker/src/server.ts",
    from: "    const reconciled = await reconcileAccount(ctx.db, parsed.data.workspaceId, parsed.data.userId, mine);",
    to: "    const reconciled = await reconcileAccount(ctx.db, parsed.data.workspaceId, parsed.data.userId, accounts);",
    pkg: "@le/worker",
  },
  {
