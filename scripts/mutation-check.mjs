...
const MUTATIONS = [
  ...
  },
  {
    ...
    from: "  if (note && !containsLink(note)) return note;",
    to: "  if (false && note && !containsLink(note)) return note;",
    pkg: "@le/worker",
  },
  {
  ...
  },
  {
    ...
    file: "apps/worker/src/jobs/linkedin-action.ts",
    from: "  return containsLink(rendered) ? \"\" : rendered;",
    to: "  return rendered;",
    pkg: "@le/worker",
  },
  {
    ...
    file: "apps/worker/src/jobs/linkedin-action.ts",
    from: "  const body = renderCta(renderTemplate(step.message, prospect.first_name), cta.url);",
    to: "  const body = renderTemplate(step.message, prospect.first_name);",
    pkg: "@le/worker",
  },
  {
