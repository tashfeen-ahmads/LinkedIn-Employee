...
const MUTATIONS = [
  ...
  {
    id: "search/an-empty-result-widens",
    rule: "A search that matches nobody is widened and tried again; a customer profile is a description, not a satisfiable conjunction",
    file: "packages/linkedin/src/unipile.ts",
    from: "      if (items.length > 0 || step.last) {",
    to: "      if (true) {",
    pkg: "@le/linkedin",
  },
  {
    ...
    file: "packages/linkedin/src/unipile.ts",
    from: "        if (step.note) notes.push(step.note);",
    to: "        // mutated: widens silently",
    pkg: "@le/linkedin",
  },
  {
    ...
    file: "packages/linkedin/src/unipile.ts",
    from: "        keywords: anyOf([...(query.titles ?? []), ...(query.keywords ?? [])]),\n      },",
    to: "        keywords: anyOf([...(query.titles ?? []), ...(query.keywords ?? [])]),\n        location: undefined,\n      },",
    pkg: "@le/linkedin",
  },
  {
